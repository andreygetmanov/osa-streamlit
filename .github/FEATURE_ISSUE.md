...
about: Want us to add any features to osa-streamlit?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with osa-streamlit. Please take the time to
...
<!--
  Why do you want to see this feature in osa-streamlit? What use cases does it support?
-->
